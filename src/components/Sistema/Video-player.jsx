...
export default function VideoPlayer({
  src = "/img/Sistema/video-marcela.mp4",
  poster = "",
}) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full max-h-96 aspect-video bg-transparent rounded-2xl overflow-hidden shadow-2xl group cursor-pointer"
