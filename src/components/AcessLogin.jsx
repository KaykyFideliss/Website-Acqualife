        ...
        <section className="h-screen w-full text-center mt-40 justify-center bg-white px-6">
            ...
            <div className='flex flex-col md:flex-row items-center justify-center gap-8 md:gap-24 px-4 md:px-8 lg:px-0 mx-auto max-w-6xl'>
                ...
                <div className='md:flex-1 text-center md:text-left'>
                    ...
                    <button class="items-center mb-2 mt-10 w-72 bg-azul-style text-white font-zalando px-5 py-2 rounded-full text-sm font-semibold hover:bg-blue-500 transition-colors"
