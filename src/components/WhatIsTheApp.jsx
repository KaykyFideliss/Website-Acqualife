...
const WhatIsTheApp = () => {
  return (
    <section id="sobre" className="w-full py-10 md:py-20 md:pl-10">
      ...
      {/* Primeiro bloco - mobile: texto em cima; desktop: texto à esquerda, imagem à direita */}
      <div className="flex flex-col md:flex-row items-center justify-center px-4 md:px-20 lg:px-40">
        {/* Texto (DOM primeiro -> garante texto primeiro no mobile) */}
      ...
      {/* Segundo bloco - mobile: texto em cima; desktop: imagem à esquerda, texto à direita */}
      <div className="pt-28 px-4 md:px-20 lg:px-40">
        <div className="flex flex-col md:flex-row-reverse items-center justify-center">
          {/* Texto (ainda é o primeiro no DOM, então fica acima no mobile) */}
          <div className="flex-1 text-center md:text-left mb-6 md:mb-0 md:mr-10">
            <h2 className="text-2xl md:text-4xl font-bold font-zalando text-[#0D6DFF] mb-4">
